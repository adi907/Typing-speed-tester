...
def game():
    ...
    entry = Entry(windows)
    entry.place(x=240, y=120, width=320,height=28)
  
    b2 = Button(windows, text="Done",command=check_result, width=12, bg='light blue')
    b2.place(x=365, y=175)
  
x1 = Label(window, text="Lets start playing..", font="times 20", bg="light pink")
x1.place(x=10, y=50)
  
b1 = Button(window, text="Go", command=game, width=12, bg='cyan')
